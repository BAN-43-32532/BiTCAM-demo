...
=a_2^\prime(t,t)x
+b_2^\prime(t,t)\mathrm{NN_{\theta}}(x,t,s)
+b_2(t,t)\mathrm{NN_{\theta2}}^\prime(x,t,s)
=a_2^\prime(t,t)x
+b_2^\prime(t,t)\mathrm{NN}_{\theta}(x,t,s)
=v(x,t)$ (the partial derivative of the second variable).
